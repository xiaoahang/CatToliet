  ...
  >
    <div class="max-w-7xl mx-auto px-6 md:px-10 h-16 md:h-20 flex items-center justify-between">
      <div class="flex items-center gap-3">
        ...
        <span class="font-serif-cn text-lg font-semibold tracking-wide" style="color: #F5F0EB;">
          猫砂柜工坊
        </span>
      </div>
      ...
      <button
        @click="scrollTo('configurator')"
        class="px-5 py-2 text-sm font-sans-en font-medium rounded-sm transition-all duration-300 hover:scale-105"
